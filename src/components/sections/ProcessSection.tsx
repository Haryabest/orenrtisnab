      ...
      >
        ...
        {PROCESS_STEPS.map((step, index) => (
          <m.div key={step.title} className="relative z-10 text-center" variants={scaleIn}>
            <m.div
              className="mx-auto grid h-12 w-12 place-items-center rounded-full border border-blue-200 bg-white font-mono text-[12px] font-bold text-[#0875e1] shadow-sm"
            >
              0{index + 1}
            </m.div>
            ...
            <p className="mx-auto mt-2 max-w-[190px] text-[12px] leading-relaxed text-slate-500">
              {step.description}
            </p>
          </m.div>
        ))}
